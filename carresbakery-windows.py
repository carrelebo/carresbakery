...
#code editor and system that I used during the development:
#-app : Vim (code editor), OS : Regolith Linux (Ubuntu 20.04.3 based)

#version of the programe make for Windows : Windows 7 until news Windows

import os

print("\nwelcome to carre's bakery, for more information type 'help' on the shell.\n")
...
[clear/cls] -> for clear the terminal program (depends on your OS)
...
#-1 clear----------------------------------------------------------------
    ...
    if 'clear' in shell:
        ...
        if len(shell) != 5:
            no_else_bug = True
            print(f"\nError, '{shell} is not the correct command -> the correct command is 'clear'.\n")
...
#-2 cls------------------------------------------------------------------
    ...
    if 'cls' in shell:
        if len(shell) == 3:
            ...
            os.system('cls')
        if len(shell) != 3:
            print(f"\nError, {shell} is not the correct command -> the correct command is 'cls'.\n")
#article command---------------------------------------------------------
